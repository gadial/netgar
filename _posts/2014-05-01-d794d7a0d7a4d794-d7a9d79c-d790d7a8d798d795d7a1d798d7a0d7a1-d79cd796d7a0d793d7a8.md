...
<p dir="RTL" style="text-align: right;">
  <span style="font-family: arial, helvetica, sans-serif;">כלי שמשמש לעשות זאת נקרא "פונקציית מביוס". הפונקציה הזאת מסומנת באות היוונית $latex { \mu }&fg=000000&bg=ffffff$   ("מו", שהיא ה"מם" היוונית, האות הראשונה בשמו של מביוס , 1790 - 1868, מתמטיקאי ואסטרונום גרמני, תלמידו של גאוס. על שמו גם נקראת "טבעת מביוס")</span>
</p>

<p dir="RTL" style="text-align: right;">
  <span style="font-family: arial, helvetica, sans-serif;">לשם כך, נצטרך לעשות הכרה עם פונקציה אריתמטית (=פונקציה שמקבלת ערכים טבעיים בלבד) הידועה בשם פונקציית מביוס - $latex { \mu }&fg=000000&bg=ffffff$. לצורך זה נגדיר מספר טבעי חסר-ריבועים כמספר שכל המחלקים הראשוניים שלו שונים. למשל המספר $latex { 3\cdot2=6 }&fg=000000&bg=ffffff$ הוא חסר ריבועים בעוד ש- $latex { 3\cdot2\cdot2=12 }&fg=000000&bg=ffffff$ לא.  עבור מספר טבעי $latex {n = p_1 \dotsm p_r }&fg=000000&bg=ffffff$ חסר ריבועים פונקציית מביוס $latex { \mu(n) }&fg=000000&bg=ffffff$  מוגדרת כ- $latex { (-1)^r }&fg=000000&bg=ffffff$ בעוד שעבור מספר שאיננו חסר-ריבועים הפונקציה מוגדרת כאפס. מתברר שלפונקציה זו יש תכונה מאוד חשובה לשיטות נפה.</span>
</p>
...
<p dir="RTL" style="text-align: right;">
  <span style="font-family: arial, helvetica, sans-serif; font-size: 14px; line-height: 1.5em;">שימו לב כי ברישום זה $latex {  \sum_{d|n} \mu(d) }&fg=000000&bg=ffffff$ פירושו סכום הערכים $latex {   \mu(d) }&fg=000000&bg=ffffff$ כאשר $latex { d }&fg=000000&bg=ffffff$ "רץ" על כל המחלקים של $latex { n }&fg=000000&bg=ffffff$.</span>
</p>

<p dir="RTL" style="text-align: right;">
  <span style="font-family: arial, helvetica, sans-serif;"><strong>דוגמא.</strong> $latex {  \sum_{d|6} \mu(d) = \mu(1) + \mu(2) + \mu(3) + \mu(6) = 1 + (-1) + (-1) + 1 = 0 }&fg=000000&bg=ffffff$ </span>
</p>

<p dir="RTL" style="text-align: right;">
  <span style="font-family: arial, helvetica, sans-serif;">נסמן: $latex { f(n) = \sum_{d|n} \mu(d) }&fg=000000&bg=ffffff$ אזי על פי המשפט נקבל כי \[ f(n) = \left\{ \begin{array}{l l} 1 & \quad n=1\\ 0 & \quad n\not=1 \end{array} \right.\]</span>
</p>

<p dir="RTL" style="text-align: right;">
  <span style="font-family: arial, helvetica, sans-serif;">מדוע זה חשוב? משום  שאנו יכולים להחליף את $latex { n }&fg=000000&bg=ffffff$ בסכום הזה במחלק המשותף המקסימלי של $latex { n }&fg=000000&bg=ffffff$  ו-$latex { m }&fg=000000&bg=ffffff$ , מספר שאנו מסמנים אותו ב-$latex { (m,n) }&fg=000000&bg=ffffff$  . כשעושים זאת מקבלים \[ f((m,n)) = \left\{ \begin{array}{l l} 1 & \quad (m,n)=1\\ 0 & \quad (m,n)\not=1 \end{array} \right.\]</span>
</p>

<p dir="RTL" style="text-align: right;">
  <span style="font-family: arial, helvetica, sans-serif;">כלומר הפונקציה תיתן 1 כל אימת ש-$latex { (m,n)=1 }&fg=000000&bg=ffffff$  (שפירושו ש -$latex { n }&fg=000000&bg=ffffff$  ו-$latex { m }&fg=000000&bg=ffffff$  זרים) ואפס אחרת. אם כעת נסמן $latex {n =2\cdot3 \dotsm p_r }&fg=000000&bg=ffffff$ אזי $latex { f((m,2\cdot3 \dotsm p_r))}&fg=000000&bg=ffffff$  יתן 1 כל אימת ש-$latex { (m,2\cdot3 \dotsm p_r)=1}&fg=000000&bg=ffffff$  כלומר כאשר כל המחלקים הראשוניים של $latex { m }&fg=000000&bg=ffffff $ גדולים מ-$latex { p_r}&fg=000000&bg=ffffff $. כלומר הסכום $latex { \sum_{m \leq x}f((m,2\cdot3 \dotsm p_r))}&fg=000000&bg=ffffff$ סופר את הטבעיים עד $latex { x}&fg=000000&bg=ffffff $ שכל המחלקים הראשוניים שלהם גדולים מ-$latex { p_r}&fg=000000&bg=ffffff $. הנקודה המעניינת היא שגם קל יחסית להעריך את הסכום האחרון. לכך לא ניכנס כאן. מכאן אפשר ללמוד כל מיני שיטות להערכת הסכום האחרון. אחת מהן היא השיטה של חתן פרס פילדס ופרס וולף הנורבגי אטלה סלברג, מגדולי המתמטיקאים של המאה ועשרים (1917-2007). את השיטה הקרויה על שמו, נפת סלברג, גילה סלברג עוד בשנות החמישים של המאה ה-20. כזכור השערת התאומים הראשוניים גורסת כי יש אינסוף זוגות של ראשוניים שהמרחק ביניהם הוא 2.</span>
</p>

<p dir="RTL" style="text-align: right;">
  <span style="font-family: arial, helvetica, sans-serif;">ב-1985 הוכיחו גולדסטון, יילדרים ופינץ באמצעות נפת סלברג כי קיימים אינסוף זוגות של ראשוניים $latex { p_n}&fg=000000&bg=ffffff $ ו-$latex { p_{n+1}}&fg=000000&bg=ffffff $ כך שהמרחק ביניהם קטן מ- $latex { \log p_n}&fg=000000&bg=ffffff $. באביב שעבר הצליח ז'אנג, מתמטיקאי סיני עלום שם, לשפר את תוצאה זו לכדי 70,000,000!  בסוף שנה שעברה, מיינהארד, פוסטדוקטורנט בריטי, הצליח בטכניקה שונה מזו של ז'אנג להקטין את המספר ל-600. כיום, עובדת קבוצה של מתמטיקאים בניסיון להקטין מספר זה דרך כל מיני שיפורים בחישובים. בדרך זו הצליחו לשפר את התוצאה ל-246!</span>
</p>
